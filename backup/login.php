...
<html>
<head>
    <!-- text/css aanpassen met ../ voor te zetten
     ook voor includes/secure_session  & <script src="js/jquery.min.js"></script>-->
    <meta charset="utf-8">
    <title>Login</title>
...
<div class="white-space" id="wrapper">
    ...
    <div id="content" class="center-horizontal">
        ...
        <!-- USER -->
            <h1 id="boer"><img class="col-xs-10 col-sm-5 col-md-3 center-horizontal" style="max-height: 236px; max-width: 448px" src="images/login/boer.png"/></h1>
...
-->
    ...
    <h1 id="cocklogin"><img class="col-xs-12" style="margin: 0 auto; float: none; max-height: 200px; max-width: 532px" src="images/stempagina/logo.png"/></h1>
    ...
    <div class="row">
        <div class="col-md-6 col-lg-3">
            ...
            <div class="visible-xs text-danger">Extra Small Devices</div>
        </div>
    </div>
    <!--
    <div id="footer">
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $('#inputUser').focusout(function () {
            ...
            var ajaxurl = 'database.php', data = {'postUser': input};
